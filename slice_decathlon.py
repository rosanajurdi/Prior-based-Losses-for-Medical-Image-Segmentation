...
def save_slices(IM_path, gt_path,
    ...
    assert set(np.unique(gt)) <= set([0., 1.])
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--source_dir', type=str, default='/media/eljurros/Transcend/thomas/nifty')
    parser.add_argument('--dest_dir', type=str, default='/media/eljurros/Transcend/thomas/npy2')
