...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--dataset', type=str, default='/media/eljurros/Transcend/Decathlone/Task10_Colon/Colon/Fold_1/npy')
    parser.add_argument("--csv", type=str, default= 'metrics.csv')
    parser.add_argument("--workdir", type=str, default = '/media/eljurros/Transcend/Decathlone/Task10_Colon/Colon/Fold_1/tmp')
    parser.add_argument('--batch_size', type=int, default=2)
    parser.add_argument("--cpu", action='store_true', default = True)
    parser.add_argument("--debug", action="store_true", default = True)
    parser.add_argument("--modalities", type=int, default=1)
    parser.add_argument("--weights", type=str, default='/media/eljurros/Transcend/Decathlone/benchmark/Colon/FOLD_1/results/HDDT/best2.pkl', help="Stored weights to restore")
