...
def save_slices(img_p: Path, gt_p: Path,
                ...
                img_dir: str = "img", gt_dir: str = "gt", in_npy_dir="in_npy", gt_npy_dir='gt_npy') -> Tuple[Any, Any, Any, Any]:
    ...
    for j in range(img.shape[-1]):
        ...
        for k in range(n_augment + 1):
            ...
            for save_dir, data, np_dir in zip([save_dir_img, save_dir_gt], 
                                              [a_img, a_gt],
                                              [save_dir_in_npy,save_dir_gt_npy] ):
                    ...
                    with warnings.catch_warnings():
                        ...
                        np.save(Path(np_dir, filename).with_suffix(".npy"), data)
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--source_dir', type=str, default = '/media/eljurros/Transcend/Decathlone/melanoma/ROOT')
    parser.add_argument('--dest_dir', type=str, default = '/media/eljurros/Transcend/Decathlone/melanoma/FOld_1')
