...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--source_dir', type=str, default='/media/eljurros/Transcend/Decathlone/Task07_Pancreas/Task07_Pancreas/nifty/FOLD_2/nifty')
    parser.add_argument('--dest_dir', type=str, default='/media/eljurros/Transcend/Decathlone/Task07_Pancreas/Task07_Pancreas/nifty/FOLD_2/npy')
