...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--source_dir', type=str, default='data/wmh')
    parser.add_argument('--dest_dir', type=str, default='data/FOLD_7')
    parser.add_argument('--img_dir', type=str, default="IMG")
    parser.add_argument('--gt_dir', type=str, default="GT")
    parser.add_argument('--shape', type=int, nargs="+", default=[256, 256])
    parser.add_argument('--retain', type=int, default=18, help="Number of retained patient for the validation data")
