...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--dataset', type=str, default='/media/eljurros/Transcend/CoordConv/ACDC/Fold_1/npy')
    parser.add_argument("--csv", type=str, default= 'metrics.csv')
    parser.add_argument("--workdir", type=str, default = '/media/eljurros/Transcend/CoordConv/ACDC/Fold_1/results/CoordCOnvDummy')
    ...
    parser.add_argument('--l_rate', nargs='?', type=float, default=0.001,
                        help='Learning Rate')
    parser.add_argument("--compute_haussdorf", action='store_true', default = True)
    ...
    parser.add_argument("--losses", type=str, 
                        ...
                        default="[('GeneralizedDice', {'idc': [0, 1]}, None, None, None, 1), ('soft_cldice_loss', {'idc': [1]}, None, None, None, 0.01), ('NaivePenalty', {'idc': [1]}, 'TagBounds', {'values': {1:[0, 2900]}, 'idc': [1]}, 'soft_size', 0.01)]")
    
    #
    parser.add_argument("--folders", type=str,
                        help="List of (subfolder, transform, is_hot)", default="[('in_npy',png_transform, False), ('gt_npy', gt_transform, True)]+[('gt_npy', gt_transform, True), \
    ('gt_npy', gt_transform, False), ('gt_npy', gt_transform, True)] "  )
