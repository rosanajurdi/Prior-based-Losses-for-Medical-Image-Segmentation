...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--source_dir', type=str, default='/media/eljurros/Transcend/Decathlone/Task02_Heart/nifty/FOLD_DUmmy')
    parser.add_argument('--dest_dir', type=str, default='/media/eljurros/Transcend/Decathlone/Task02_Heart/nifty/FOLD_DUmmy/npy')
