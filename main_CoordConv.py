...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--dataset', type=str, default='/media/eljurros/Transcend/Decathlone/melanoma/FOLD_1')
    ...
    parser.add_argument("--losses", type=str, 
                        ...
                        default="[('GeneralizedDice', {'idc': [0, 1]}, None, None, None, 1), ('contour_loss',{'idc': [0, 1]}, None, None, None, 0.01)]")
    ...
    parser.add_argument("--scheduler", type=str, default="StealWeight")
    parser.add_argument("--scheduler_params", type=str, default="{'to_steal': 0.01}")
